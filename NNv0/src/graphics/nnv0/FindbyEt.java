...
public class FindbyEt extends Activity {
     ...
     * @param savedInstanceState: instancia inicial. 
     * */
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.findbyetlayout);
	...
	findViewById(R.id.buttonfind).setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			if(clases.equals("Clases:"))
			 ...
			 Intent in = new Intent(FindbyEt.this,VerNotas.class);	
			 in.putExtra("result",clases);
			 startActivity(in);	    
		}			
	});
 ...
 * @param nombre2: Clase de la que se parte. 
 * */
public void draw(final String nombre2, boolean act){
	...
	for(int i = 0; i< miV.size(); i++){
	    ...
	    llp.setMargins(25, 10, 0, 0); // llp.setMargins(left, top, right, bottom);

	    ImageButton but = new ImageButton(this); 
	    Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.ico_mas);
	    RelativeLayout.LayoutParams lbp = new RelativeLayout.LayoutParams(43,43);
